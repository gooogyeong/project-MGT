      ...
      <div className="intro-wrapper">
        ...
        <div>
          ...
          <section>
            ...
            <p>오선영은 한국과 영국을 기반으로 활동하는 시각 예술가이다. 영국의 Goldsmiths, University of London에서 순수미술을 전공하며, 주로 연극적인 무대장치 연출과
              퍼포먼스, 영상 매체를 활용하여 지극히 내밀한 개인사나 주변인들과의 관계에서 경험하는 감정의 파열을 다뤄왔다. 이러한 흐름의 연장선상에서 오선영은 《모던 그로테스크 타임스》를 통해 한국 사회에서의
              ‘가족’이라는 존재, 그리고 그들과 맺는 관계를 심층적으로 탐구한다.</p><br/>
